...
/**
 * main - Simple Shell main function. Creates a prompt that reads input, parses it, executes commands,
...
int main(int ac __attribute__((unused)), char **av, char **env)
{
    ...
    {
        prompt();
        line = read_input(); /* Read input and return string */
        args = split_str(line, env); /* Separate string to get command and arguments */
